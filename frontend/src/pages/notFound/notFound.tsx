        ...
        <MainComponent>
            <div className={styles.separator_container}>
                ...
                <div className={styles.text_container}>
                    <h5 className={styles.red_text}>{t('404.not_found1')}</h5>
                    <h5 className={styles.red_text}>{t('404.not_found2')}</h5>
                    <h5>{t('404.not_found3')}</h5>
                </div>
                <div className={styles.footer_container}>
                    <h5 className={styles.italic_text}>{t('404.404')}</h5>
                    <Link to={homePath}>
