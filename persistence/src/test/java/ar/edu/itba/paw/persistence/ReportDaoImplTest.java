...
public class ReportDaoImplTest {
    ...
    private static final long KNOWN_REPORT_ID = 1;
    ...
    public void testCreateReport(){
        ...
        //Assert
        Assert.assertEquals(USER_2.getUserId(),ans.getReporter().getUserId());
        Assert.assertEquals(USER_1.getUserId(),ans.getReported().getUserId());
    ...
    public void testFindById(){
        //Execute
        Optional<Report> ans = reportDao.findById(1);
        //Assert
