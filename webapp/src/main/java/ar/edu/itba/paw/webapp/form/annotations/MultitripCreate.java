...
@Constraint(validatedBy = MultitripCreateValidator.class)
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
public @interface MultitripCreate {
    String message() default "{MultitripCreate.error}";
    Class<?>[] groups() default { };
    Class<? extends Payload>[] payload() default { };
}

class MultitripCreateValidator implements ConstraintValidator<MultitripCreate, CreateTripForm> {
    @Override
