...
<body class="background-bg-color">
    ...
    <div class="container-bg-color main-container-style">
        <div class="title-container">
            ...
            <h1 class="danger title"><spring:message code="notFound403.title"/></h1>
        </div>
        <h5 class="danger"><spring:message code="notFound403.description"/></h5>
        <div class="footer-container">
            <div class="error-code-container error-code">
                <p class="error-code-style"><spring:message code="notFound403.errorMessage" arguments=":"/></p>
                <em><spring:message code="notFound403.errorCode"/></em>
            </div>
            <a class="anchor-style" href="<c:url value="/"/>">
                <button class="btn button-bg-color button-style">
                    <span class="light-text h5"><spring:message code="notFound403.btnBack"/></span>
                </button>
            </a>
        </div>
    </div>
