...
<html>
  ...
  <body class="background-bg-color">
    ...
    <div class="container-bg-color main-container-style">
      ...
      <h5 class="danger">Parece que llegaste al final de la carretera. La página que buscás no está en esta ruta.</h5>
      <div class="footer-container">
        <div class="error-code-container">
          <p class="error-code-style">Código de error:</p>
          <em>404 Not Found</em>
        </div>
        <a class="anchor-style" href="<c:url value="/"/>">
          <button class="btn button-bg-color button-style">
            <span class="light-text h5">Volver al buscador</span>
          </button>
        </a>
      </div>
    </div>
