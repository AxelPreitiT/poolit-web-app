  ...
  <body class="background-bg-color">
    ...
    <div class="container-bg-color main-container-style">
      <div class="title-container">
        ...
        <h1 class="danger title"><spring:message code="notFound.title"/></h1>
      </div>
      <h5 class="danger"><spring:message code="notFound.description"/></h5>
      <div class="footer-container">
        <div class="error-code-container error-code">
          <p class="error-code-style"><spring:message code="notFound.errorMessage" arguments=":"/></p>
          <em><spring:message code="notFound.errorCode"/></em>
        </div>
        <a class="anchor-style" href="<c:url value="/"/>">
          <button class="btn button-bg-color button-style">
            <span class="light-text h5"><spring:message code="notFound.btnBack"/></span>
          </button>
        </a>
      </div>
    </div>
