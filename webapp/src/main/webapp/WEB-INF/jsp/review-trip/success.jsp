...
<html>
<head>
    <title><spring:message code="reviewTrip.success.title"/></title>
    <jsp:include page="/resources/external-resources.jsp"/>
    <jsp:include page="/WEB-INF/jsp/base/base.css.jsp"/>
    <link href="<c:url value="/resources/css/review-trip/success.css"/>" rel="stylesheet">
</head>
...
<div id="toast-container">
    <jsp:include page="/WEB-INF/jsp/components/success-toast.jsp">
        ...
        <jsp:param name="message" value="reviewTrip.success.pageTitle"/>
    </jsp:include>
</div>
</body>
</html>
